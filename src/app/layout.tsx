  ...
  return (
    <html lang="pt-br">
      ...
      >
        ...
        <div className="absolute z-20 rotate-12 animate-breath-light-to-dark bottom-[-750px] sm:bottom-[-600px] right-20 w-48 h-48 bg-gradient-to-br from-[#ffffffa1] to-transparent opacity-50 rounded-lg"></div>
        ...
        <div className="absolute z-20 rotate-6 animate-breath-light-to-dark bottom-[-2000px]  sm:bottom-[-600px] left-20 w-20 h-20 bg-gradient-to-br from-[#ffffffa1] to-transparent opacity-50 rounded-lg"></div>
